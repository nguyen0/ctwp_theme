...
const styleSRC = './assets/src/styles/main.scss';
...
const jsVendorSRC = './assets/src/scripts/vendor/*.js';
...
const jsCustomSRC = './assets/src/scripts/custom/*.js';
...
const watchStyles = './assets/src/styles/**/*.scss';

// Path to all vendor JS files.
const watchJsVendor = './assets/src/scripts/vendor/*.js';

// Path to all custom JS files.
const watchJsCustom = './assets/src/scripts/custom/*.js';
...
const textDomain = 'ctwp_theme';

// Name of the translation file.
const translationFile = 'ctwp_theme.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'ctwp_theme';
